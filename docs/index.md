...
permalink: /
layout: default
description: "Kernel Memory (KM) is a multi-modal AI Service specialized
...
Kernel Memory allows to import information from documents, presentations, images,
web pages, JSON files, spreadsheets, [and more](/extensions/data-formats).
