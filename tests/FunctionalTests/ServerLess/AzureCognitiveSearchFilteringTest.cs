...
public class AzureCognitiveSearchFilteringTest : BaseTestCase
{
    private readonly ISemanticMemoryClient _memory;

    public AzureCognitiveSearchFilteringTest(IConfiguration cfg, ITestOutputHelper output) : base(output)
    {
